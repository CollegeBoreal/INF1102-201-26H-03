...
$ips | Group-Object | Sort-Object Count -Descending | Select-Object -First 5 | ForEach-Object {
    $count = $_.Count
    $name  = $_.Name
    "$count $name" | Out-File $rapport -Append
}
...
$pages | Group-Object | Sort-Object Count -Descending | Select-Object -First 5 | ForEach-Object {
    $count = $_.Count
    $name  = $_.Name
    "$count $name" | Out-File $rapport -Append
}
