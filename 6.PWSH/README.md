...
Utiliser **PowerShell sous Linux** apporte plusieurs avantages, surtout dans un contexte **administration système, DevOps ou automatisation multi-plateforme**. Voici les principaux points :
...
| **Liste des processus**   | `ps aux                         | sort -nrk 4                                                                           | head -n 5`                                                                             | `Get-Process                                                                               | Sort-Object WS -Descending | Select-Object -First 5` | PowerShell renvoie des objets avec propriétés (`Name`, `CPU`, `WS`). |
...
| **Rapports / Logs**       | `echo ... >> log.txt`           | `Write-Output ...                                                                     | Tee-Object log.txt`                                                                    | `Tee-Object` permet d’afficher et d’écrire en même temps, plus pratique pour batch DevOps. |                            |                         |                                                                      |
