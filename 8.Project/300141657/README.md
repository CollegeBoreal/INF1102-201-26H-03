...
- **Projet :** Monitoring site web

---

## Objectif

Ce projet a pour objectif de vérifier la disponibilité d’un site web et de mesurer son temps de réponse à l’aide de scripts PowerShell et Python.

Le système permet de :

- tester l’accès HTTP à un site web
- enregistrer les résultats dans un fichier CSV
- générer un rapport texte automatique
- produire un graphique de l’évolution du temps de réponse
- préparer une base d’analyse pour le notebook `RAPPORT.ipynb`

Le site surveillé dans ce projet est :
...
1. Le script `analyse.ps1` vérifie la disponibilité du site web.
2. Il mesure le temps de réponse HTTP.
3. Il enregistre les données dans `monitoring.csv`.
4. Il appelle `analyse.py`.
5. Le script Python génère `rapport.txt`.
6. Il produit aussi un graphique `temps_reponse.png`.
7. Les résultats peuvent ensuite être analysés dans `RAPPORT.ipynb`.
...
<p align="center">
  <img src="images/Image23.png" alt="Structure du projet avec tree /f" width="900">
</p>
...
<p align="center">
  <img src="images/Image24.png" alt="Contenu du script analyse.ps1" width="900">
</p>
...
<p align="center">
  <img src="images/Image25.png" alt="Contenu du script analyse.py" width="900">
</p>
...
<p align="center">
  <img src="images/Image26.png" alt="Execution du script analyse.ps1" width="900">
</p>
...
<p align="center">
  <img src="images/Image27.png" alt="Contenu du fichier monitoring.csv" width="900">
</p>
...
<p align="center">
  <img src="images/Image28.png" alt="Contenu du fichier rapport.txt" width="900">
</p>
...
<p align="center">
  <img src="images/Image29.png" alt="Verification du dossier output" width="900">
</p>
...
<p align="center">
  <img src="images/Image30.png" alt="Graphique des temps de reponse" width="900">
</p>
...
<p align="center">
  <img src="images/Image31.png" alt="Executions multiples du script de monitoring" width="900">
</p>
...
<p align="center">
  <img src="images/Image32.png" alt="Historique du monitoring apres plusieurs executions" width="900">
</p>
...
Le projet démontre l’utilisation combinée de deux langages de script :
...
Ce projet répond donc à l’objectif demandé : utiliser les langages de script appris en cours dans une situation concrète et utile.
